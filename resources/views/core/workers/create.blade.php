...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="card-box">
            {!! Form::open(array('route' => 'workers.store','method'=>'POST','class'=>'form-horizontal','id'=>'FormSubmit','role'=>'form', 'enctype'=>'multipart/form-data')) !!}
                <div class="row">
                    <div class="col-md-6">
                        <fieldset>
                    ...
                    <div class="col-md-6">
                        <fieldset>
                            ...
                            <div class="form-group {{ $errors->has('password') ? ' has-error' : '' }}">
                                <label class="col-md-3 control-label">Kata Sandi <span class="text-danger">*</span> </label>
                                <div class="col-md-9">
                        ...
                        <fieldset>
                            ...
                            <div class="form-group {{ $errors->has('gender_id') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-9">
                                    ...
                                    @php $checked = $gender->id == old('gender_id') ? "checked" : "" ; @endphp
                            ...
                            <div class="form-group {{ $errors->has('status_id') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-9">
                                    ...
                                    @php $checked = $marital->id == old('status_id') ? "checked" : "" ; @endphp
                                    <div class="radio radio-inline radio-primary">
                            ...
                            <div class="form-group {{ $errors->has('total_child') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-9">
                                    <input type="number" min="0" class="form-control" id="total_child" name="total_child" value="{{ old('total_child') ? old('total_child') : 0 }}">
                            ...
                            <div class="form-group {{ $errors->has('blood_id') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-9">
                                    ...
                                    @php $checked = $blood->id == old('blood_id') ? "checked" : "" ; @endphp
                                    <div class="radio radio-inline radio-primary">
                            ...
                            <div class="form-group {{ $errors->has('use_lens') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-9">
                                    <div class="radio radio-inline radio-primary">
                                        <input id="use_lens" type="radio" name="use_lens" value="1" {{ old('use_lens') == "1" ? "checked" : "" }}>
                                        <label for="use_lens">
                                            Ya
                                        </label>
                                    </div>
                                    <div class="radio radio-inline radio-primary">
                                        <input id="use_lens" type="radio" name="use_lens" value="0" {{  old('use_lens') == "0" ? "checked" : "" }}>
                                        <label for="use_lens">
                                            Tidak
                                        </label>
                                    </div>
                            ...
                            <div class="form-group {{ $errors->has('weight') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-9">
                                    <input type="number" class="form-control" id="weight" name="weight" min="0" step="any" value="{{ old('weight') }}">
                            ...
                            <div class="form-group {{ $errors->has('height') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-9">
                                    <input type="number" class="form-control" id="height" name="height" min="0" step="any" value="{{ old('height') }}">
                            ...
                            <div class="form-group {{ $errors->has('family_number') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-9">
                                    <input type="text" class="form-control" id="family_number" name="family_number" value="{{ old('family_number') }}">
                            ...
                            <div class="form-group {{ $errors->has('medical_number') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-9">
                                    <input type="text" class="form-control" id="medical_number" name="medical_number" value="{{ old('medical_number') }}">
