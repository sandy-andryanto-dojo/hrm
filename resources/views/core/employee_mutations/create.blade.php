...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="card-box">
            ...
            <hr>
            {!! Form::open(array('route' => 'employee_mutations.store','method'=>'POST','class'=>'form-horizontal','id'=>'FormSubmit','role'=>'form')) !!}
                ...
                <div class="form-group {{ $errors->has('division_from_id') ? ' has-error' : '' }}">
                    ...
                    <div class="col-md-10">
                        <input type="text" readonly="readonly" id="division_from_name" value="-" class="form-control" />
                        <input type="hidden" readonly="readonly" id="division_from_id" name="division_from_id" class="form-control" />
