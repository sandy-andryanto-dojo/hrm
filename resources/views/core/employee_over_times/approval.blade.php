<div class="modal fade" id="myModal">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            {!! Form::model(null, ['method' => 'PATCH','class'=>'form-horizontal','id'=>'form-approve','route' => ['employee_over_times.update', 0] ,'enctype'=>'multipart/form-data']) !!}
                ...
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Form Persetujuan Lembur</h4>
                </div>
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <input type="text" class="form-control" id="_tanggal_lembur" readonly="readonly" />
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-3 control-label">Waktu Mulai</label>
                        <div class="col-md-9">
                            <input type="text" class="form-control" id="_waktu_mulai" readonly="readonly" />
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-3 control-label">Waktu Selesai</label>
                        <div class="col-md-9">
                            <input type="text" class="form-control" id="_waktu_selesai" readonly="readonly" />
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-3 control-label">Alasan Lembur</label>
                        <div class="col-md-9">
