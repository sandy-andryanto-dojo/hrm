...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="card-box">
            ...
            <hr>
            {!! Form::open(array('route' => 'employee_over_times.store','method'=>'POST','class'=>'form-horizontal','id'=>'FormSubmit','role'=>'form')) !!}
                <div class="form-group {{ $errors->has('request_date') ? ' has-error' : '' }}">
                    ...
                    <div class="col-md-10">
                        <input type="text" class="form-control input-datepicker" id="request_date" name="request_date" value="{{ old('request_date') }}">
                ...
                <div class="form-group {{ $errors->has('start_hour') ? ' has-error' : '' }}">
                    ...
                    <div class="col-md-10">
                        <input type="text" class="form-control input-hour" id="start_hour" name="start_hour" value="{{ old('start_hour') ? old('start_hour') : date('H:m') }}">
                ...
                <div class="form-group {{ $errors->has('end_hour') ? ' has-error' : '' }}">
                    ...
                    <div class="col-md-10">
                        <input type="text" class="form-control input-hour" id="end_hour" name="end_hour" value="{{ old('end_hour') ? old('end_hour') : date('H:m') }}">
