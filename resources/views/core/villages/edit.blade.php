...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="card-box">
            ...
            <hr>
            {!! Form::model($data, ['method' => 'PATCH','class'=>'form-horizontal','id'=>'FormSubmit','route' => ['villages.update', $data->id] ,'enctype'=>'multipart/form-data']) !!}
                ...
                <div class="form-group {{ $errors->has('province_id') ? ' has-error' : '' }}">
                    ...
                    <div class="col-md-10">
                        {!! Form::select('province_id', $provinces->pluck('name','id'), $data->District->Regency->province_id, ['id'=>'province_id','class'=>'select2', 'placeholder'=>'-- Pilih Provinsi --']) !!}
                ...
                <div class="form-group {{ $errors->has('regency_id') ? ' has-error' : '' }}">
                    ...
                    <div class="col-md-10">
                        <select name="regency_id" id="regency_id">
                            <option value="{{ $data->District->regency_id }}" selected="selected">{{ $data->District->Regency->name }}</option>
                        </select>
                ...
                <div class="form-group {{ $errors->has('district_id') ? ' has-error' : '' }}">
                    ...
                    <div class="col-md-10">
                        <select name="district_id" id="district_id">
                            <option value="{{ $data->district_id }}" selected="selected">{{ $data->District->name }}</option>
                        </select>
