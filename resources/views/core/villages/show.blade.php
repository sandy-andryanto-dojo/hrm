        ...
        <div class="card-box">
            <div class="clearfix">
                ...
                <div class="pull-right">
                    <a href="{{ route('villages.create') }}" class="btn btn-success btn-create-data btn-sm">
                        <i class="fa fa-plus"></i>&nbsp;Tambah Data
                    </a>
                    <a href="{{ route('villages.edit',['category'=>$data->id]) }}"
            ...
            <table class="table table-striped table-colored table-info dt-responsive nowrap">
                ...
                <tr>
                    <td>Provinsi</td>
                    <td>:</td>
                    <td>{{ $data->District->Regency->Province->name }}</td>
                </tr>
                <tr>
                    <td>Kabupaten / Kota</td>
                    <td>:</td>
                    <td>{{ $data->District->Regency->name }}</td>
                </tr>
                <tr>
                    <td>Kecamatan</td>
                    <td>:</td>
