...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="card-box">
            ...
            <hr>
            {!! Form::open(array('route' => 'positions.store','method'=>'POST','class'=>'form-horizontal','id'=>'FormSubmit','role'=>'form')) !!}
                ...
                <div class="form-group {{ $errors->has('hour_salary') ? ' has-error' : '' }}">
                    ...
                    <div class="col-md-10">
                        <input type="text" class="form-control" id="hour_salary" name="hour_salary" value="{{ old('hour_salary') }}">
                ...
                <div class="form-group {{ $errors->has('month_salary') ? ' has-error' : '' }}">
                    ...
                    <div class="col-md-10">
                        <input type="text" class="form-control" id="month_salary" name="month_salary" value="{{ old('month_salary') }}">
