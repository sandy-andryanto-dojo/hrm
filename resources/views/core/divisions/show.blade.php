        ...
        <div class="card-box">
            <div class="clearfix">
                ...
                <div class="pull-right">
                    <a href="{{ route('divisions.create') }}" class="btn btn-success btn-create-data btn-sm">
                        <i class="fa fa-plus"></i>&nbsp;Tambah Data
                    </a>
                    <a href="{{ route('divisions.edit',['category'=>$data->id]) }}"
            ...
            <table class="table table-striped table-colored table-info dt-responsive nowrap">
                ...
                <tr>
                    <td>Nama Pimpinan</td>
                    <td>:</td>
                    <td>{{ $data->Superior ? $data->Superior->first_name." ".$data->Superior->last_name : "-" }}</td>
                </tr>
                <tr>
                    <td>Deskripsi</td>
                    <td>:</td>
