...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="card-box">
            ...
            <hr>
            {!! Form::open(array('route' => 'employee_travels.store','method'=>'POST','class'=>'form-horizontal','id'=>'FormSubmit','role'=>'form')) !!}
                <div class="form-group {{ $errors->has('destination') ? ' has-error' : '' }}">
                    <label class="col-md-2 control-label">Destinasi <span class="text-danger">*</span></label>
                    <div class="col-md-10">
                        <div class="radio radio-inline radio-primary">
                            <input id="domestic" class="destination" type="radio" name="destination" value="1" {{ old('destination') }}>
                            <label for="domestic">
                                Dalam Negeri
                            </label>
                        </div>
                        <div class="radio radio-inline radio-primary">
                            <input id="foreign" class="destination" type="radio" name="destination" value="2" {{ old('destination') }}>
                            <label for="foreign">
                                Luar Negeri
                            </label>
                        </div>
                ...
                <div class="form-group {{ $errors->has('cost') ? ' has-error' : '' }}">
                    ...
                    <div class="col-md-10">
                        <input type="text" class="form-control" id="cost" name="cost" value="{{ old('cost') ? old('cost') : 0.00 }}">
                        @if ($errors->has('cost'))
                            <span class="help-block text-danger">
