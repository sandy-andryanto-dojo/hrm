<div class="modal fade" id="myModal">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            {!! Form::model(null, ['method' => 'PATCH','class'=>'form-horizontal','id'=>'form-approve','route' => ['employee_travels.update', 0] ,'enctype'=>'multipart/form-data']) !!}
                ...
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Form Persetujuan Dinas</h4>
                </div>
                <div class="modal-body">
                    <div class="form-group">
                        <label class="col-md-3 control-label">Destinasi</label>
                        <div class="col-md-9">
                            <input type="text" class="form-control" id="_destinasi" readonly="readonly" />
                        </div>
                    </div>
                    <div class="form-group foreign">
                        <label class="col-md-3 control-label">Negara Tujuan</label>
                        <div class="col-md-9">
                            <input type="text" class="form-control" id="_negara" readonly="readonly" />
                        </div>
                    </div>
                    <div class="form-group domestic">
                        <label class="col-md-3 control-label">Provinsi</label>
                        <div class="col-md-9">
                            <input type="text" class="form-control" id="_provinsi" readonly="readonly" />
                        </div>
                    </div>
                    <div class="form-group domestic">
                        <label class="col-md-3 control-label">Kota</label>
                        <div class="col-md-9">
                            <input type="text" class="form-control" id="_kota" readonly="readonly" />
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label class="col-md-3 control-label">Tanggal Mulai Dinas</label>
                        <div class="col-md-9">
                            <input type="text" class="form-control" id="_tgl_mulai" readonly="readonly" />
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-3 control-label">Tanggal Akhir Dinas</label>
                        <div class="col-md-9">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <input type="text" class="form-control" id="_biaya" readonly="readonly" />
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-3 control-label">Alasan Dinas</label>
                        <div class="col-md-9">
