...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="card-box">
            <div class="clearfix">
                <div class="pull-left">
                    <h4>Daftar Permohonan Dinas</h4>
                </div>
                <div class="pull-right">
                    <a href="{{ route('employee_travels.create') }}" class="btn btn-success btn-sm btn-create-data">
                        <i class="fa fa-plus"></i>&nbsp;Tambah Baru
                    </a>
                    <a href="{{ route('employee_travels.show', ['id'=>0]) }}" class="btn btn-warning btn-sm btn-detail">
