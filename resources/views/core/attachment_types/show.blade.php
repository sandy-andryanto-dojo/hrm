...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="card-box">
            <div class="clearfix">
                <div class="pull-left">
                    <h4>Detail Jenis Lampiran</h4>
                </div>
                <div class="pull-right">
                    <a href="{{ route('attachment_types.create') }}" class="btn btn-success btn-create-data btn-sm">
                        <i class="fa fa-plus"></i>&nbsp;Tambah Data
                    </a>
                    <a href="{{ route('attachment_types.edit',['category'=>$data->id]) }}"
            ...
            <table class="table table-striped table-colored table-info dt-responsive nowrap">
                ...
                <tr>
                    ...
                    @if((int)$data->is_required == 1)
                        <td>{!! \App\Helpers\AppHelper::statusText("success", "Wajib") !!}</td>
                    @else
                        <td>{!! \App\Helpers\AppHelper::statusText("warning", "Tidak Wajib") !!}</td>
                    @endif
                </tr>
                <tr>
                    <td>Deskripsi</td>
