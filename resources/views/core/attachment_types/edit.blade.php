...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="card-box">
            ...
            <hr>
            {!! Form::model($data, ['method' => 'PATCH','class'=>'form-horizontal','id'=>'FormSubmit','route' => ['attachment_types.update', $data->id] ,'enctype'=>'multipart/form-data']) !!}
                ...
                <div class="form-group {{ $errors->has('is_required') ? ' has-error' : '' }}">
                    ...
                    <div class="col-md-10">
                        <div class="checkbox">
                            <input type="checkbox" name="is_required" id="is_required" value="1" {{ (int)$data->is_required == 1 ? "checked" : "" }} ><label for="is_required">Ya</label> 
                        </div>
