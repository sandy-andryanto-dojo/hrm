...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="card-box">
            <div class="clearfix">
                <div class="pull-left">
                    <h4>Daftar Jenis Lampiran</h4>
                </div>
                <div class="pull-right">
                    <a href="{{ route('attachment_types.create') }}" class="btn btn-success btn-sm btn-create-data">
                        <i class="fa fa-plus"></i>&nbsp;Tambah Baru
                    </a>
                    <a href="{{ route('attachment_types.show', ['id'=>0]) }}" class="btn btn-warning btn-sm btn-detail">
