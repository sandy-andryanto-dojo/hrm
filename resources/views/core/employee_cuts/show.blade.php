...
@section('title') Potongan @endsection
...
<div class="row">
    <div class="col-xs-12">
        <div class="page-title-box">
            <h4 class="page-title"> Potongan</h4>
            <ol class="breadcrumb p-0 m-0">
                ...
                <li>
                    <a href="{{ route('employee_cuts.index') }}"> Data Potongan</a>
                </li>
                <li class="active">
                    Detail Data
                </li>
    ...
    <div class="col-md-12">
        ...
        <div class="card-box">
            <div class="clearfix">
                ...
                <div class="pull-right">
                    <a href="{{ route('employee_cuts.index') }}" class="btn btn-primary btn-sm">
        ...
        <div class="card-box">
            <div class="clearfix">
                ...
                <div class="pull-right">
                    @if(count($cuts_employee) > 0)
                        <a href="{{ route('employee_cuts.edit', ['id'=>$data->id]) }}" class="btn btn-info btn-sm">
                            <i class="fa fa-edit"></i>&nbsp;Edit
                        </a>
                    @else
                        <a href="{{ route('employee_cuts.edit', ['id'=>$data->id]) }}" class="btn btn-success btn-sm">
