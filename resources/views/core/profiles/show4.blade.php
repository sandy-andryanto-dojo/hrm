...
@section('title') Keahlian @endsection

@section('script')
    <script src="{{ asset('assets/app/js/profiles-skills.js') }}"></script>
@endsection
...
{!! Form::model(null, ['method' => 'PATCH','class'=>'','id'=>'form-delete','route' => ['profiles.update', 4] ,'enctype'=>'multipart/form-data']) !!}
        ...
        <div class="modal-content">
            {!! Form::open(array('route' => 'profiles.store','method'=>'POST','class'=>'form-horizontal','id'=>'FormSubmit','role'=>'form')) !!}
                ...
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Form Keahlian</h4>
                </div>
                <div class="modal-body">
                    <div class="form-group">
                        <label class="col-md-3 control-label">Nama Keahlian </label>
                        <div class="col-md-9">
                            <input type="text" id="name" name="name" class="form-control" required="required" />
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-3 control-label">Tingkat Kemahiran</label>
                        <div class="col-md-9">
                            {!! Form::select('level', $levels, null, ['id'=>'level','class'=>'select2', 'placeholder'=>'-- Pilih Tingkat Kemahiran --']) !!}
                        </div>
                    </div>
                    <div class="form-group">
