<div id="crop-avatar">
        ...
        <div class="avatar-view">
            <img class="profile-user-img img-responsive img-thumbnail" src="{{ \App\Helpers\UserHelper::getProfileImage() }}" alt="User profile picture">
            <p></p>
            <a href="javascript:void(0);" class="btn btn-primary btn-block btn-sm"><b><i class="fa fa-upload"></i> Ganti Pas Foto</b></a>
        </div>
        ...
        <div class="modal fade" id="avatar-modal" aria-hidden="true" aria-labelledby="avatar-modal-label" role="dialog"
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <form class="avatar-form" action="{{ route('api.upload.profile') }}"  enctype="multipart/form-data" method="post">
                        {{ csrf_field() }}
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal">&times;</button>
                            <h4 class="modal-title" id="avatar-modal-label">Pas Foto</h4>
                        </div>
