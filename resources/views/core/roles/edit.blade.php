...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="card-box">
            ...
            <hr>
            {!! Form::model($data, ['method' => 'PATCH','class'=>'form-horizontal','id'=>'FormSubmit','route' => ['roles.update', $data->id] ,'enctype'=>'multipart/form-data']) !!}
                <div class="form-group {{ $errors->has('name') ? ' has-error' : '' }}">
                    <label class="col-md-2 control-label">Nama Akses <span class="text-danger">*</span> </label>
                    <div class="col-md-10">
                        <input type="text" class="form-control" id="name" name="name" value="{{ $data->name }}" {{ $data->name == 'Admin' ? 'readonly="readonly"' : '' }}>
                        @if ($errors->has('name'))
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-10">
                        <button type="submit" class="btn btn-success waves-effect waves-light" {{ $data->name == 'Admin' ? 'disabled="disabled"' : '' }}>
                            <i class="fa fa-save"></i>&nbsp; Simpan
                        </button>
                        <button type="reset" class="btn btn-warning waves-effect waves-light" {{ $data->name == 'Admin' ? 'disabled="disabled"' : '' }}>
