...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="card-box">
            ...
            <hr>
            {!! Form::open(array('route' => 'holidays.store','method'=>'POST','class'=>'form-horizontal','id'=>'FormSubmit','role'=>'form')) !!}
                ...
                <div class="form-group {{ $errors->has('date_holiday') ? ' has-error' : '' }}">
                    ...
                    <div class="col-md-10">
                        <input type="text" class="form-control input-datepicker" id="date_holiday" name="date_holiday" value="{{ old('date_holiday') }}">
