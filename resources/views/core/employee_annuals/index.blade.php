        ...
        <div class="card-box">
            <div class="clearfix">
                ...
                <div class="pull-right">
                    <a href="{{ route('employee_annuals.create') }}" class="btn btn-success btn-sm btn-create-data">
                        <i class="fa fa-plus"></i>&nbsp;Tambah Baru
                    </a>
                    <a href="{{ route('employee_annuals.show', ['id'=>0]) }}" class="btn btn-warning btn-sm btn-detail">
...
@include('core.employee_annuals.approval')
