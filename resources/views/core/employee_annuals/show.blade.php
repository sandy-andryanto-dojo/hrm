...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="card-box">
            <div class="clearfix">
                <div class="pull-left">
                    <h4>Detail Permohonan Cuti</h4>
                </div>
                <div class="pull-right">
                    @if($employee_id != $data->manager_id)
                        <a href="{{ route('employee_annuals.create') }}" class="btn btn-success btn-create-data btn-sm">
                            <i class="fa fa-plus"></i>&nbsp;Tambah Data
                        </a>
                        @if((int) $data->is_approved == 0)
                        <a href="{{ route('employee_annuals.edit',['category'=>$data->id]) }}"
