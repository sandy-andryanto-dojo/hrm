...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="card-box">
            <div class="clearfix">
                <div class="pull-left">
                    <h4>Detail Promosi Pegawai</h4>
                </div>
                <div class="pull-right">
                    <a href="{{ route('employee_promotions.create') }}" class="btn btn-success btn-create-data btn-sm">
                        <i class="fa fa-plus"></i>&nbsp;Tambah Data
                    </a>
                    <a href="{{ route('employee_promotions.edit',['category'=>$data->id]) }}"
            ...
            <table class="table table-striped table-colored table-info dt-responsive nowrap">
                ...
                <tr>
                    <td>Posisi Asal</td>
                    <td>:</td>
                    <td>{{ $data->PositionFrom ? $data->PositionFrom->name : "-" }}</td>
                </tr>
                <tr>
                    <td>Divisi Tujuan</td>
                    <td>:</td>
                    <td>{{ $data->PositionTarget ? $data->PositionTarget->name : "-" }}</td>
                </tr>
                <tr>
                    <td>Nama Atasan</td>
                    <td>:</td>
