$(document).ready(function() {
    ...
    $("body").on("click", ".btn-approve", function(e) {
        ...
        $("#_tanggal_lembur").val(json.request_date);
        $("#_waktu_mulai").val(json.start_hour);
        $("#_waktu_selesai").val(json.end_hour);
    ...
    if ($(".notif").length) {
        ...
        if ($(".notif_over_times").length) {
            $(".notif_over_times").removeClass("hidden").text(textNotif);
        }
    }
